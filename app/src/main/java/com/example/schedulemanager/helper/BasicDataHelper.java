...
public class BasicDataHelper {
    ...
    private void makeLife(ArrayList<ActivityVO> basicDataList) {
        ActivityVO basicActivity12 = new ActivityVO("일상/생활", "연락", "T", dataHelper.getByteArrayFromDrawable(R.drawable.icon_233), basicDataList);
        ActivityVO basicActivity13 = new ActivityVO("일상/생활", "연락처 관리", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_201), basicDataList);
        ActivityVO basicActivity14 = new ActivityVO("일상/생활", "알람설정", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_202), basicDataList);
        ActivityVO basicActivity15 = new ActivityVO("일상/생활", "샤워", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_203), basicDataList);
        ActivityVO basicActivity16 = new ActivityVO("일상/생활", "술", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_204), basicDataList);
        ActivityVO basicActivity17 = new ActivityVO("일상/생활", "쓰레기 버리기", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_205), basicDataList);
        ActivityVO basicActivity18 = new ActivityVO("일상/생활", "점심식사", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_206), basicDataList);
        ActivityVO basicActivity19 = new ActivityVO("일상/생활", "병원가기", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_207), basicDataList);
        ActivityVO basicActivity20 = new ActivityVO("일상/생활", "클라우드 사용", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_208), basicDataList);
        ActivityVO basicActivity22 = new ActivityVO("일상/생활", "커피타임", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_209), basicDataList);
        ActivityVO basicActivity24 = new ActivityVO("일상/생활", "컴퓨터 작업", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_210), basicDataList);
        ActivityVO basicActivity25 = new ActivityVO("일상/생활", "주차", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_211), basicDataList);
        ActivityVO basicActivity26 = new ActivityVO("일상/생활", "챗팅", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_212), basicDataList);
        ActivityVO basicActivity29 = new ActivityVO("일상/생활", "보드게임", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_213), basicDataList);
        ActivityVO basicActivity30 = new ActivityVO("일상/생활", "게임", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_214), basicDataList);
        ActivityVO basicActivity31 = new ActivityVO("일상/생활", "음악감상", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_215), basicDataList);
        ActivityVO basicActivity32 = new ActivityVO("일상/생활", "간식", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_216), basicDataList);
        ActivityVO basicActivity322 = new ActivityVO("일상/생활", "인터넷", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_217), basicDataList);
        ActivityVO basicActivity33 = new ActivityVO("일상/생활", "위치파악", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_218), basicDataList);
        ActivityVO basicActivity34 = new ActivityVO("일상/생활", "뉴스확인", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_219), basicDataList);
        ActivityVO basicActivity35 = new ActivityVO("일상/생활", "영화감상", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_220), basicDataList);
        ActivityVO basicActivity36 = new ActivityVO("일상/생활", "메세지", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_221), basicDataList);
        ActivityVO basicActivity37 = new ActivityVO("일상/생활", "약먹기", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_222), basicDataList);
        ActivityVO basicActivity38 = new ActivityVO("일상/생활", "저녁식사", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_223), basicDataList);
        ActivityVO basicActivity39 = new ActivityVO("일상/생활", "검색", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_224), basicDataList);
        ActivityVO basicActivity40 = new ActivityVO("일상/생활", "수리", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_225), basicDataList);
        ActivityVO basicActivity41 = new ActivityVO("일상/생활", "쇼핑", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_226), basicDataList);
        ActivityVO basicActivity42 = new ActivityVO("일상/생활", "취미활동", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_227), basicDataList);
        ActivityVO basicActivity43 = new ActivityVO("일상/생활", "가게가기", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_228), basicDataList);
        ActivityVO basicActivity44 = new ActivityVO("일상/생활", "티타임", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_229), basicDataList);
        ActivityVO basicActivity45 = new ActivityVO("일상/생활", "TV", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_230), basicDataList);
        ActivityVO basicActivity46 = new ActivityVO("일상/생활", "와인한잔", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_231), basicDataList);
        ActivityVO basicActivity47 = new ActivityVO("일상/생활", "온라인 게임", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_232), basicDataList);
        ActivityVO basicActivity48 = new ActivityVO("일상/생활", "VR", "F", dataHelper.getByteArrayFromDrawable(R.drawable.icon_200), basicDataList);
    }
